import {
    DELETE_PRODUCTS, GET_ALL_PRODUCTS_BRAND,
    GET_ALL_PRODUCTS_CATEGORY, UPDATE_PRODUCTS, CREATE_PRODUCTS,
    GET_PRODUCT_LIKE, GET_PRODUCT_DETALIS, GET_ALL_PRODUCTS, GET_ERROR
} from '../type';
